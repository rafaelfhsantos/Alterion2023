...
local function constructNew_frmVantagem()
    ...
    obj.edit3:setField("familiaridade_pag");
...
function newfrmVantagem()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmVantagem();
      end,
      function()
...
frmVantagem = _frmVantagem;
Firecast.registrarForm(_frmVantagem);
